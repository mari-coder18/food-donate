...
function DashboardLayout({ children }) {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 overflow-x-hidden w-full relative">
      ...
      {/* 📱 MOBILE OVERLAY (Black transparent bg when sidebar is open) */}
      {sidebarOpen && (
        <div
      ...
      <div className="flex-1 flex flex-col min-w-0 md:ml-0">
        ...
        {/* 🔝 HEADER */}
        <div className="bg-white px-4 md:px-8 py-4 shadow-sm flex justify-between items-center sticky top-0 z-10">
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <button
              ...
              className="bg-red-500 hover:bg-red-600 text-white px-3 py-1 md:px-4 md:py-2 rounded-lg text-sm transition"
            >
              Logout
            </button>
          </div>
